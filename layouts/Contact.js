      ...
      <div className="container mx-auto">
        <div className="flex justify-center">
          <div className="w-full">
            <div className="mb-5  flex contact-details justify-center">
              <div className="w-1/4 contact-details-div">
                ...
                <div className="text-center">
                  <p className="mt-2">
                    <span className="font-bold">Address:</span> 6th of October City, Al Mehwar Al Markazi, Golden mall, 1st floor, office #9
                  </p>
                </div>
              </div>
              <div className="w-1/4 contact-details-div">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="text-center">
                  <p className="mt-2">
                    ...
                    <a href="http://b-circles.co/" target="_blank">www.b-circles.co</a>
                  </p>
                </div>
              </div>
            </div>
            <div className="flex bg-theme-light dark:bg-[#141111d9] rounded">
                  ...
                  >
                    <div className="-mx-4 flex flex-wrap">
                      <div className="w-1/2 px-4">
                        <div className="mb-4">
                          <label className="dark:text-white text-gray-700" htmlFor="name">
                            Full Name
                          </label>
                          <input
                            type="text"
                            className="block border-none dark:bg-[#192221a1] rounded-lg w-full px-4 py-2"
                            name="name"
                            id="name"
                            placeholder="Name"
                          />
                      ...
                      <div className="w-1/2 px-4">
                        <div className="mb-4">
                          ...
                          <input
                            type="email"
                            className="block border-none dark:bg-[#192221a1] w-full rounded-lg px-4 py-2"
                            name="email"
                            id="email"
                            placeholder="Email"
                          />
                      ...
                      <div className="w-full px-4">
                        <div className="mb-4">
                          <label className="dark:text-white text-gray-700" htmlFor="subject">
                            Subject
                          </label>
                          <input
                            type="text"
                            className="block border-none dark:bg-[#192221a1] w-full rounded-lg rounded px-4 py-2"
                            name="subject"
                            id="subject"
                            placeholder="Subject"
                          />
                      ...
                      <div className="w-full px-4">
                        <div className="mb-4">
                          <label className="dark:text-white text-gray-700" htmlFor="message">
                            Message
                          </label>
                          <textarea
                            name="message"
              ...
              <div class="w-1/3 flex p-3 bg-[#4de2d014] c_bg">
              <svg
