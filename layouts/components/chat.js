...
const ChatInterface = () => {
  ...
  return (
    <div className={`shadow-xl overflow-hidden rounded-t-3xl fixed bottom-0 max-w-[350px] dark:bg-[#0e0c0c] bg-white w-full right-[10%] z-50 ${isChatOpen ? 'open' : 'closed'}`}>
      <div className=" bg-blue-500 dark:bg-[#141111d9] text-white cursor-pointer p-3" onClick={toggleChat}>
